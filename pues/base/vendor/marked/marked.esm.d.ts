...
export type HooksApi<ParserOutput = string, RendererOutput = string> = Omit<
...
export type RendererApi<ParserOutput = string, RendererOutput = string> = Omit<
  _Renderer<ParserOutput, RendererOutput>,
...
export type TokenizerApi<ParserOutput = string, RendererOutput = string> = Omit<
...
export interface MarkedOptions<ParserOutput = string, RendererOutput = string>
  extends Omit<
...
declare function _getDefaults<
  ParserOutput = string,
  RendererOutput = string,
>(): MarkedOptions<ParserOutput, RendererOutput>;
...
export declare class Marked<ParserOutput = string, RendererOutput = string> {
  ...
  parse: {
    ...
    (
      src: string,
      options?: MarkedOptions<ParserOutput, RendererOutput> | null,
...
export declare namespace marked {
  ...
  var parseInline: {
    ...
    (
      src: string,
      options?: MarkedOptions<string, string> | null | undefined,
    ): string | Promise<string>;
  };
