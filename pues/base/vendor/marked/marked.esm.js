...
`),
          ...
          const S = this.rules.other.nextBulletRegex(f),
            ...
            xe = this.rules.other.blockquoteBeginRegex(f);
          for (; e; ) {
            let Z = e.split(
                `
`,
...
`),
        ...
        i.loose ||
          (a
            ? (i.loose = !0)
            : this.rules.other.doubleBlankLine.test(p) && (a = !0)),
          i.items.push({
            type: "list_item",
            raw: p,
      ...
      for (const l of i.items) {
        if (
          ...
          if (
            ...
            for (let c = this.lexer.inlineQueue.length - 1; c >= 0; c--)
              if (
                this.rules.other.listIsTask.test(this.lexer.inlineQueue[c].src)
              ) {
        ...
        if (!i.loose) {
          const p = l.tokens.filter((d) => d.type === "space"),
            c =
              p.length > 0 &&
...
var x = class u {
  ...
  constructor(e) {
    ...
    const t = { other: m, block: B.normal, inline: E.normal };
    this.options.pedantic
      ? ((t.block = B.pedantic), (t.inline = E.pedantic))
      : this.options.gfm &&
        ((t.block = B.gfm),
        this.options.breaks ? (t.inline = E.breaks) : (t.inline = E.gfm)),
  ...
  use(...e) {
    ...
    return (
      e.forEach((n) => {
        ...
        if (n.tokenizer) {
          const i = this.defaults.tokenizer || new w(this.defaults);
        ...
        if (n.hooks) {
          const i = this.defaults.hooks || new P();
        ...
        if (n.walkTokens) {
          ...
          r.walkTokens = function (a) {
            let o = [];
            return (
              o.push(s.call(this, a)), i && (o = o.concat(i.call(this, a))), o
            );
          };
        }
...
Please report this to https://github.com/markedjs/marked.`),
        ...
        const r =
          "<p>An error occurred:</p><pre>" + O(n.message + "", !0) + "</pre>";
...
g.options = g.setOptions = (u) => (
  L.setOptions(u), (g.defaults = L.defaults), G(g.defaults), g
);
g.getDefaults = M;
g.defaults = T;
g.use = (...u) => (L.use(...u), (g.defaults = L.defaults), G(g.defaults), g);
g.walkTokens = (u, e) => L.walkTokens(u, e);
